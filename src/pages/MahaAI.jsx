...
const departments = [
  ...
  { 
    name: 'Co-operation, Marketing and Textiles Department', 
    website: 'cooperation.maharashtra.gov.in', 
    image: '/mp/Textile.png' 
  },
  { 
  ...
  { 
    ...
    website: 'rfd.maharashtra.gov.in', 
    image: '/mp/stamp.png' 
  },
  { 
    name: 'Urban Development Department', 
    website: 'urban.maharashtra.gov.in', 
    image: '/mp/Urban1.png' 
  },
  { 
    name: 'Transport Department', 
    website: 'transport.maharashtra.gov.in', 
    image: '/mp/Transport1.png' 
  },
  { 
    name: 'Planning Department', 
    website: 'plan.mahaitgov.in', 
    image: '/delhi_dept.jpg' 
  },
  { 
  ...
  { 
    name: 'Skill Development, Employment and Entrepreneurship Department', 
    website: 'mahaskills.gov.in', 
  ...
  return (
    <div className="w-100">
      ...
      {isMobile ? (
        ...
        <section className="position-relative bg-dark" style={{height:"auto"}}>
          ...
          <div style={{
            ...
            >
             AI Powered Citizen Support For Maharashtra            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              style={{ fontSize: '1rem' }}
            >
          Revolutionizing Maharashtra Government Services With Intelligent AI Solutions.
      ...
      <section className="position-relative bg-dark d-flex flex-column flex-md-row flex-sm-row align-items-center justify-content-center" style={{ minHeight: "600px", height: "95vh" }}>
        ...
        {/* Right Side: Content */}
        <div className="d-flex flex-column justify-content-center align-items-center py-5" style={{ width: "100%", maxWidth: "50vw", zIndex: 2 }}>
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          ...
          >
            AI Powered Citizen Support For Maharashtra
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 className="display-5 fw-bold mb-4">About MaharashtraAI</h2>
                <p className="lead mb-4">
                  MaharashtraAI is dedicated to transforming government services across the state using cutting-edge Artificial Intelligence Agents.
                </p>
                <p className="mb-4">
