                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text text-muted">
                      AI-powered {service.name.toLowerCase()} solutions for Maharashtra citizens
                    </p>
                    <motion.button
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 className="display-5 fw-bold mb-4">About Maharashtra AI</h2>
                <p className="lead mb-4">
                  Maharashtra AI is dedicated to transforming government services across the state using cutting-edge artificial intelligence.
                </p>
                <p className="mb-4">
            ...
            <div className="col-lg-6">
              <motion.img
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5 }}
                src="https://source.unsplash.com/random/600x400?maharashtra"
