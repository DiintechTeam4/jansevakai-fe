...
const UttarAI = () => {
  ...
  return (
    <div className="w-100">
        ...
        <section className="position-relative" style={{height:"auto"}}>
          ...
          <div style={{
            ...
            <motion.p
              ...
              style={{ fontSize: '1rem' }}
            >
              Revolutionizing Uttar Pradesh  Government Services With Intelligent AI Solutions.
            </motion.p>
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text text-muted">
                      AI-powered {service.name.toLowerCase()} solutions for Uttar Pradesh  citizens
                    </p>
                    <motion.button
      ...
      {/* About Uttar Pradesh  AI Section */}
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              ...
              >
                ...
                <p className="lead mb-4">
                  Uttar Pradesh  AI is dedicated to transforming government services across the state using cutting-edge artificial intelligence.
                </p>
                <p className="mb-4">
            ...
            <div className="col-lg-6">
              <motion.img
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5 }}
                src="https://source.unsplash.com/random/600x400?Uttar Pradesh "
