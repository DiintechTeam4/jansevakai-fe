      ...
      {isMobile ? (
        ...
        <section className="position-relative bg-dark" style={{height:"auto"}}>
          ...
          <div style={{
            ...
            >
             AI Powered Citizen Support For Uttar Pradesh           </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 className="display-5 fw-bold mb-4">About Uttar Pradesh AI</h2>
                <p className="lead mb-4">
                  Uttar Pradesh AI is dedicated to transforming government services across the state using cutting-edge Artificial Intelligence Agents.
                </p>
                <p className="mb-4">
