...
const departments = [
  { name: 'Administrative Reforms', website: 'ard.delhi.gov.in', image: '/adminis.png' },
  { name: 'Archaeology Department', website: 'delhi.gov.in/departments-offices/archaeology-department', image: '/archeology.png' },
  { name: 'Art, Culture and Language', website: 'delhi.gov.in/departments-offices/art-culture-language-department', image: '/art.png' },
  { name: 'Delhi Archives', website: 'delhi.gov.in/departments-offices/delhi-archives-department', image: '/Delhi-Archieve.png' },
  { name: 'Delhi Jal Board', website: 'delhijalboard.delhi.gov.in', image: '/Jalboard.png' },
  { name: 'Development Department', website: 'development.delhi.gov.in', image: '/development.png' },
  { name: 'Directorate of Education', website: 'edudel.nic.in', image: '/Education.png' },
  { name: 'Directorate of Employment', website: 'delhi.gov.in/departments-offices/directorate-employment', image: '/Employment.png' },
  { name: 'Directorate of Training & Technical Education (DTTE)', website: 'dtte.delhi.gov.in', image: '/technical.png' },
  { name: 'Drugs Control Department', website: 'delhi.gov.in/departments-offices/drugs-control-department', image: '/Pharm.png' },
  // { name: 'Environment Department', website: 'environment.delhi.gov.in', image: '/delhi_dept.jpg' },
  // { name: 'Excise, Entertainment & Luxury Tax', website: 'delhi.gov.in/departments-offices/excise-entertainment-luxury-tax-department', image: '/delhi_dept.jpg' },
...
const DelhiAI = () => {
  ...
  return (
    <div className="w-100">
      ...
      {isMobile ? (
        ...
        <section className="position-relative bg-dark" style={{height:"auto"}}>
          ...
          <div style={{
            ...
            >
             AI Powered Citizen Support For Delhi            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="position-relative bg-dark d-flex flex-column flex-md-row flex-sm-row align-items-center justify-content-center" style={{ minHeight: "600px", height: "95vh" }}>
        {/* Left Side: Image */}
        ...
        {/* Right Side: Content */}
        <div className="d-flex flex-column justify-content-center align-items-center px-4 py-5" style={{ width: "100%", maxWidth: "50vw", zIndex: 2 }}>
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 className="display-5 fw-bold mb-4">About DelhiAI</h2>
                <p className="lead mb-4">
                  DelhiAI is dedicated to transforming government services across the state using cutting-edge Artificial Intelligence Agents.
                </p>
                <p className="mb-4">
