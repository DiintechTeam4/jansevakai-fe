...
Revolutionizing Citizen Services with Agentic AI             </motion.h2>
            <motion.p
              ...
              style={{ fontSize: '1rem' }}
            >
          Revolutionizing Rajasthan Government Services With Intelligent AI Solutions.
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 className="display-5 fw-bold mb-4">About RajasthanAI</h2>
                <p className="lead mb-4">
                  RajasthanAI is dedicated to transforming government services across the state using cutting-edge Artificial Intelligence Agents.
                </p>
                <p className="mb-4">
