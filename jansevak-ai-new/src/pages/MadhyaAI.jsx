...
Revolutionizing Citizen Services with Agentic AI             </motion.h2>
            <motion.p
              ...
              style={{ fontSize: '1rem' }}
            >
          Revolutionizing MP Government Services With Intelligent AI Solutions.
        ...
        <section
        className="position-relative bg-dark d-flex flex-column flex-md-row gap-5 flex-sm-row align-items-center justify-content-space-between"
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 className="display-5 fw-bold mb-4">About MadhyaAI</h2>
                <p className="lead mb-4">
                  MadhyaAI is dedicated to transforming government services across the state using cutting-edge Artificial Intelligence Agents.
                </p>
                <p className="mb-4">
